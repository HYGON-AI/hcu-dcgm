...
func main() {
	...
	// //HCU设备指定类型的内存使用情况 [vram|vis_vram|gtt
	// dcgm.MemInfo(0, "vram")
	...
	// //指定设备的HSL错误状态（K100_AI卡不支持该操作）
	// dcgm.ShowHSLErr([]int{0, 1, 2}, true)
	use, err := dcgm.HCUUse(0)
	if err != nil {
		glog.Error(err)
		return
	}
